...
mod test {
    ...
    pub const BLANK_HASH: [u8; 32] = [158, 68, 82, 252, 122, 237, 147, 215, 36, 11, 123, 85, 38, 55, 146, 190, 253, 27, 224, 146, 82, 180, 86, 64, 17, 34, 186, 113, 165, 111, 98, 160];
    // a50a3310f78cbaeadcffe2d46262119eeeda9d6568b4df1b636399742c867aca
    pub const HASH_34_1: [u8; 32] = [165, 10, 51, 16, 247, 140, 186, 234, 220, 255, 226, 212, 98, 98, 17, 158, 238, 218, 157, 101, 104, 180, 223, 27, 99, 99, 153, 116, 44, 134, 122, 202];
    // d7b68a8ba4cfc606e86ed7e2ca3244ff27b28bb24c28ee09af4b1f47af9b9236
    pub const HASH_32_1_2_2: [u8; 32] = [215, 182, 138, 139, 164, 207, 198, 6, 232, 110, 215, 226, 202, 50, 68, 255, 39, 178, 139, 178, 76, 40, 238, 9, 175, 75, 31, 71, 175, 155, 146, 54];
    #[test]
    fn empty_eaglesong() {
        let mut output = [0 as u8; 32];
        let input = [];
